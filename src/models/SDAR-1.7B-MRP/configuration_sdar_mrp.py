...
class SDARMRPConfig(PretrainedConfig):
    r"""
    ...
    Args:
        ...
        num_nextn_predict_layers (`int`, *optional*, defaults to 1):
            Number of hidden layers in the MRP module.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Declared explicitly so they survive on transformers>=5, where the
        # base PretrainedConfig no longer accepts these as named kwargs.
        ...
        self.num_mrp_heads = num_mrp_heads
