...
class CreateLatestSymlinkCallback(TrainerCallback):
    r"""After each checkpoint save, update <output_dir>/latest -> absolute path of the checkpoint."""
    ...
    def on_save(self, args: "TrainingArguments", state: "TrainerState", control: "TrainerControl", **kwargs):
        ...
        os.symlink(abs_checkpoint_dir, latest_link)
